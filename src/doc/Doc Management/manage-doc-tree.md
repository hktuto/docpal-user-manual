...
::: info 按钮位置
+ <a href="/v1.1.6/manage-doc-tree.html#_1-1-按钮组功能区-文件夹右上角按钮组-步骤1">按钮组功能区：`新建`按钮下的`上传文件`按钮、`上传文件夹`按钮</a>
+ <a href="/v1.1.6/manage-doc-tree.html#_1-3-右键功能区-右击文件或表格空白地方会弹出-右键功能区-步骤4">右键功能区：`上传文件`按钮、`上传文件夹`按钮</a>
:::
...
5. 同时内部人员可在<a href="/v1.1.6/o-share-file.html">分享文件管理</a>中查看并管理正在分享中的所有文件.
...
::: info 按钮位置
+ <a href="/v1.1.6/manage-doc-tree.html#_1-3-右键功能区-右击文件或表格空白地方会弹出-右键功能区-步骤4">右键功能区：`内部分享`按钮</a>
:::
1. 提交后数据会出现在`内部分享管理`页面供分享人管理分享内容
2. 提交后数据会出现在`内部分享列表`页面供被分享人查看分享内容